...
data class BaseFlowNavigationScreen(
    val index: Int,
    ...
    override fun Content() {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = { navigator.push(BaseFlowNavigationScreen(index.inc(), wrapContent)) },
                    modifier = Modifier.weight(.5f)
                ) {
                    Text(text = "Push")
                }
                ...
                Button(
                    onClick = { navigator.replace(BaseFlowNavigationScreen(index.inc(), wrapContent)) },
                    modifier = Modifier.weight(.5f)
                ) {
                    Text(text = "Replace")
                }
